...
//@interface Dorosh_Ian_Project1Object : NSObject
//@end

@interface Dorosh_Ian_Project1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Dorosh_Ian_Project1Object class]])
		{
			for (NSString *key in [[(Dorosh_Ian_Project1Object*)o modules] allKeys])
			{

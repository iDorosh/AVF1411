...
@interface Dorosh_Ian_Project1Object : KrollCoverageObject {
#else
@interface Dorosh_Ian_Project1Object : KrollObject {
#endif
@private
...
extern NSString * Dorosh_Ian_Project1$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Dorosh_Ian_Project1Object *_dorosh_ian_project1;
    KrollObject* console;
	BOOL shutdown;

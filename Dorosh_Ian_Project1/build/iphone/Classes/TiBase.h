...
// in simulator we redefine to format for Dorosh_Ian_Project1 Developer console
...
{\
	NSString * exceptionName = [@"org.dorosh_ian_project1." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.dorosh_ian_project1";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIDorosh_Ian_Project1NativeItemNone = -1, 
	UIDorosh_Ian_Project1NativeItemSpinner = -2,
	UIDorosh_Ian_Project1NativeItemProgressBar = -3,
	
	UIDorosh_Ian_Project1NativeItemSlider = -4,
	UIDorosh_Ian_Project1NativeItemSwitch = -5,
	UIDorosh_Ian_Project1NativeItemMultiButton = -6,
	UIDorosh_Ian_Project1NativeItemSegmented = -7,
	
	UIDorosh_Ian_Project1NativeItemTextView = -8,
	UIDorosh_Ian_Project1NativeItemTextField = -9,
	UIDorosh_Ian_Project1NativeItemSearchBar = -10,
	
	UIDorosh_Ian_Project1NativeItemPicker = -11,
	UIDorosh_Ian_Project1NativeItemDatePicker = -12,
	
	UIDorosh_Ian_Project1NativeItemInfoLight = -13,
	UIDorosh_Ian_Project1NativeItemInfoDark = -14,
	
	UIDorosh_Ian_Project1NativeItemDisclosure = -15,
	
	UIDorosh_Ian_Project1NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Dorosh_Ian_Project1 instances of

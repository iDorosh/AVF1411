 ...
 * to send analytic data that can be viewed on the Dorosh_Ian_Project1 Dashboard.
 *
 * For information on getting started with Dorosh_Ian_Project1 Platform Services,

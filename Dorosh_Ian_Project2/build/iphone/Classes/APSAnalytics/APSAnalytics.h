 ...
 * to send analytic data that can be viewed on the Dorosh_Ian_Project2 Dashboard.
 *
 * For information on getting started with Dorosh_Ian_Project2 Platform Services,

...
//@interface Dorosh_Ian_Project2Object : NSObject
//@end

@interface Dorosh_Ian_Project2Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Dorosh_Ian_Project2Object class]])
		{
			for (NSString *key in [[(Dorosh_Ian_Project2Object*)o modules] allKeys])
			{

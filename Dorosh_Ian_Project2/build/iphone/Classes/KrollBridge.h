...
@interface Dorosh_Ian_Project2Object : KrollCoverageObject {
#else
@interface Dorosh_Ian_Project2Object : KrollObject {
#endif
@private
...
extern NSString * Dorosh_Ian_Project2$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Dorosh_Ian_Project2Object *_dorosh_ian_project2;
    KrollObject* console;
	BOOL shutdown;

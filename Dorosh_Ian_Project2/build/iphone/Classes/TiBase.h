...
// in simulator we redefine to format for Dorosh_Ian_Project2 Developer console
...
{\
	NSString * exceptionName = [@"org.dorosh_ian_project2." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.dorosh_ian_project2";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIDorosh_Ian_Project2NativeItemNone = -1, 
	UIDorosh_Ian_Project2NativeItemSpinner = -2,
	UIDorosh_Ian_Project2NativeItemProgressBar = -3,
	
	UIDorosh_Ian_Project2NativeItemSlider = -4,
	UIDorosh_Ian_Project2NativeItemSwitch = -5,
	UIDorosh_Ian_Project2NativeItemMultiButton = -6,
	UIDorosh_Ian_Project2NativeItemSegmented = -7,
	
	UIDorosh_Ian_Project2NativeItemTextView = -8,
	UIDorosh_Ian_Project2NativeItemTextField = -9,
	UIDorosh_Ian_Project2NativeItemSearchBar = -10,
	
	UIDorosh_Ian_Project2NativeItemPicker = -11,
	UIDorosh_Ian_Project2NativeItemDatePicker = -12,
	
	UIDorosh_Ian_Project2NativeItemInfoLight = -13,
	UIDorosh_Ian_Project2NativeItemInfoDark = -14,
	
	UIDorosh_Ian_Project2NativeItemDisclosure = -15,
	
	UIDorosh_Ian_Project2NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Dorosh_Ian_Project2 instances of

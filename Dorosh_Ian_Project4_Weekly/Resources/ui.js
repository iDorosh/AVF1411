...
var create = function(day,newEvent,newDesc){
	Cloud.Events.create({
    user_id: "546cf34f44f2450e5e0a3de4",
    start_time: "2012-09-30 03:15:57 +0000",
    name: newEvent,
   	details: day,
   	custom_fields: {
   		description: newDesc,
...
var addProject = function(day){
	console.log(day);
		...
		start.addEventListener("click", function(e){
			create(day,clientName.value,projectName.value,day);
		});
...
var rainDrop = Ti.UI.createImageView({
	image: "icons/raindrop.png",
	height: 25,
	bottom: 80,
	right: 95,
});

var wind = Ti.UI.createImageView({
...
row.addEventListener("click",function(event){
	...
	deleteEvent.addEventListener("click",function(e){
		var  eventId;
		if(event.source.id == "546e6f16f13f3a442f098896" || event.source.id == "546e6d1840f2edfe100ac701"|| event.source.id == "546e6bc9f13f3a0a350ad804" || event.source.id == "546e6d1840f2edfe100ac701"){

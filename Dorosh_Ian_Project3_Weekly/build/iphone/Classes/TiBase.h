...
// in simulator we redefine to format for Dorosh_Ian_Project3_Weekly Developer console
...
{\
	NSString * exceptionName = [@"org.dorosh_ian_project3_weekly." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.dorosh_ian_project3_weekly";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIDorosh_Ian_Project3_WeeklyNativeItemNone = -1, 
	UIDorosh_Ian_Project3_WeeklyNativeItemSpinner = -2,
	UIDorosh_Ian_Project3_WeeklyNativeItemProgressBar = -3,
	
	UIDorosh_Ian_Project3_WeeklyNativeItemSlider = -4,
	UIDorosh_Ian_Project3_WeeklyNativeItemSwitch = -5,
	UIDorosh_Ian_Project3_WeeklyNativeItemMultiButton = -6,
	UIDorosh_Ian_Project3_WeeklyNativeItemSegmented = -7,
	
	UIDorosh_Ian_Project3_WeeklyNativeItemTextView = -8,
	UIDorosh_Ian_Project3_WeeklyNativeItemTextField = -9,
	UIDorosh_Ian_Project3_WeeklyNativeItemSearchBar = -10,
	
	UIDorosh_Ian_Project3_WeeklyNativeItemPicker = -11,
	UIDorosh_Ian_Project3_WeeklyNativeItemDatePicker = -12,
	
	UIDorosh_Ian_Project3_WeeklyNativeItemInfoLight = -13,
	UIDorosh_Ian_Project3_WeeklyNativeItemInfoDark = -14,
	
	UIDorosh_Ian_Project3_WeeklyNativeItemDisclosure = -15,
	
	UIDorosh_Ian_Project3_WeeklyNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Dorosh_Ian_Project3_Weekly instances of

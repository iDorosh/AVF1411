...
//@interface Dorosh_Ian_Project3_WeeklyObject : NSObject
//@end

@interface Dorosh_Ian_Project3_WeeklyObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Dorosh_Ian_Project3_WeeklyObject class]])
		{
			for (NSString *key in [[(Dorosh_Ian_Project3_WeeklyObject*)o modules] allKeys])
			{

 ...
 * to send analytic data that can be viewed on the Dorosh_Ian_Project3_Weekly Dashboard.
 *
 * For information on getting started with Dorosh_Ian_Project3_Weekly Platform Services,

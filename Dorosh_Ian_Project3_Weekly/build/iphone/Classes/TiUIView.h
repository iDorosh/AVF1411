...
/**
 Base class for all Dorosh_Ian_Project3_Weekly views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Dorosh_Ian_Project3_Weekly view hierarchy (such as wrapped iOS UIViews) was touched.

...
@interface Dorosh_Ian_Project3_WeeklyObject : KrollCoverageObject {
#else
@interface Dorosh_Ian_Project3_WeeklyObject : KrollObject {
#endif
@private
...
extern NSString * Dorosh_Ian_Project3_Weekly$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Dorosh_Ian_Project3_WeeklyObject *_dorosh_ian_project3_weekly;
    KrollObject* console;
	BOOL shutdown;
